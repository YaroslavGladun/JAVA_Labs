...
public class TradingPoint implements Serializable {
    ...
    public void setWorkTimeInDay(int weekDayNumber, String workTime) throws Exception {
        if (weekDayNumber < 1 || weekDayNumber > 7) throw new Exception("Unknown week day");
